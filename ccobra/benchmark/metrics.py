    ...
    def to_html(self, res_df, benchmark_name, embedded=False):
        ...
        for metric in self.metrics:
            ...
            html_out.extend([
                ...
                "                    format: 'png',",
                "                    filename: 'ccobra_plot',",
                "                    height: 500,",
                "                    width: 1500",
                "                },",
                "                modeBarButtonsToRemove: ['sendDataToCloud', 'select2d', 'toggleSpikelines', 'hoverCompareCartesian', 'hoverClosestCartesian', 'lasso2d', 'zoom2d', 'pan2d', 'autoScale2d'],",
                "                displaylogo: false",
                "            }",
                "            Plotly.newPlot('{}', data, layout, config);".format(metric_div),
